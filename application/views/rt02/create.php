 <div class="container">
  	<div class="card">
  		<div class="card-header">Add Warga</div>
  		<div class="card-body">
  			<?php 
  			...
  			?>
  			<form method="post" action="<?php echo base_url(); ?>rt02/save">
          ...
          <div class="text-center">
            <a href="<?php echo base_url(); ?>rt02/index" class="btn btn-success">Back</a>
